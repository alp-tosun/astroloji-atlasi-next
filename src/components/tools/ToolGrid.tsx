...
export interface ToolDef {
  ...
  premium?: boolean;
  live?: boolean;
  section: 'daily' | 'sky' | 'discover' | 'more';
}
...
export const TOOLS: ToolDef[] = [
  ...
  // ── Keşfet ──
  { id: 'burc', icon: '♈', nameKey: 'card_burc_name', descKey: 'card_burc_desc', section: 'discover' },
  { id: 'yuk', icon: '🌅', nameKey: 'card_yuk_name', descKey: 'card_yuk_desc', section: 'discover' },
  { id: 'ay-burc', icon: '🌙', nameKey: 'card_ay_burc_name', descKey: 'card_ay_burc_desc', section: 'discover' },
  { id: 'num', icon: '🔢', nameKey: 'card_num_name', descKey: 'card_num_desc', premium: true, section: 'discover' },
  { id: 'uyum', icon: '💞', nameKey: 'card_uyum_name', descKey: 'card_uyum_desc', premium: true, section: 'discover' },
  { id: 'ruya', icon: '💭', nameKey: 'card_ruya_name', descKey: 'card_ruya_desc', premium: true, section: 'discover' },
  { id: 'tarot', icon: '🎴', nameKey: 'card_tarot_name', descKey: 'card_tarot_desc', premium: true, section: 'discover' },

  // ── Daha Fazla ──
  { id: 'haftalik', icon: '📅', nameKey: 'card_haftalik_name', descKey: 'card_haftalik_desc', premium: true, section: 'more' },
  { id: 'aylik', icon: '🗓️', nameKey: 'card_aylik_name', descKey: 'card_aylik_desc', premium: true, section: 'more' },
  { id: 'gecmis', icon: '📜', nameKey: 'card_gecmis_name', descKey: 'card_gecmis_desc', section: 'more' },
  { id: 'kosm', icon: '🔮', nameKey: 'card_kosm_name', descKey: 'card_kosm_desc', premium: true, section: 'more' },
  { id: 'el', icon: '✋', nameKey: 'card_el_name', descKey: 'card_el_desc', premium: true, section: 'more' },
  { id: 'horar', icon: '✦', nameKey: 'card_horar_name', descKey: 'card_horar_desc', premium: true, section: 'more' },
];

const SECTIONS = [
  { key: 'daily', labelKey: 'sect_bugun', fallback: 'Bugun', icon: '☀️', gradient: 'from-amber-500/20 via-orange-500/5' },
  { key: 'sky', labelKey: 'sect_gokyuzu', fallback: 'Gokyuzu', icon: '🌌', gradient: 'from-blue-500/20 via-indigo-500/5' },
  { key: 'discover', labelKey: 'sect_kesfet', fallback: 'Kesfet', icon: '🔭', gradient: 'from-emerald-500/20 via-teal-500/5' },
  { key: 'more', labelKey: 'sect_daha_fazla', fallback: 'Daha Fazla', icon: '📂', gradient: 'from-rose-500/20 via-pink-500/5' },
] as const;
      ...
      {SECTIONS.map((section) => {
        ...
        return (
          <button
            ...
            className={`group relative rounded-2xl border p-4 text-left transition-all duration-300 overflow-hidden ${
              isActive
          ...
          >
            ...
            <div className="flex items-center gap-2.5 mb-2.5">
              <span className={`text-2xl transition-transform duration-200 ${isActive ? 'scale-110' : 'group-hover:scale-105'}`}>
                {section.icon}
              </span>
